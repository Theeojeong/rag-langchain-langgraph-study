...
stock_research_agent = create_react_agent(
    ...
    state_modifier="You are a stock researcher. Provide facts only not opinions",
)
...
def company_research_tool(ticker: str) -> dict:
    ...
    return {"financial_info": financial_info, "sec_filings": sec_filings}
...
company_research_agent = create_react_agent(
    ...
    state_modifier="You are a company researcher. Provide facts only not opinions",
)
