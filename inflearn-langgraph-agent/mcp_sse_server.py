...
def tax_deductible_tool(question: str) -> str:
    ...
    user_deductible_chain = (
        user_deductible_prompt_template | small_llm | StrOutputParser()
    )
...
def house_tax_tool(
    tax_base_question: str, market_value_rate: str, tax_deductible: str, question: str
) -> str:
...
@mcp.prompt(
    name="house_tax_system_prompt", description="""종합부동산세 계산 프롬프트"""
)
